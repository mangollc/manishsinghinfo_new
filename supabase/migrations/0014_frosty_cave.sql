...
1. Content Management Functions
  - get_content_overview: Get all content with filtering and pagination
  - get_content_stats: Get content statistics by type and status
  - get_draft_content: Get draft content items
  - get_published_content: Get published content items

2. Activity Tracking Functions
  - get_activities_with_users: Get activity log entries with user details
